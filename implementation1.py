...
#VIDEO_SOURCE = 'videos/walking_the_dog.mp4'
VIDEO_SOURCE = 'videos/walking_the_dog.mp4'
    ...
    while cap.isOpened():
        ...
        for cnt in contours:
            ...
            if area >= minArea:
                ...
                cv2.putText(frame,'Motion Detection',(10,50),FONT,0.8, TEXT_COLOR ,2, cv2.LINE_AA)
        ...
        cv2.imshow('BGmarks',bg_mask)
        cv2.imshow('marks',  result)
